...
public class SubscriptionController {
	...
	{	
		...
		int flag=0;
		ResponseEntity<BookSubscription[]> response = new RestTemplate().getForEntity("http://localhost:8002/books",BookSubscription[].class);
		BookSubscription[] list = response.getBody();
		for(BookSubscription books:list) {
